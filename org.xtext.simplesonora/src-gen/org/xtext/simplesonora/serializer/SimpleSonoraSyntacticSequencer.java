...
public class SimpleSonoraSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SimpleSonoraGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (SimpleSonoraGrammarAccess) access;
	}
