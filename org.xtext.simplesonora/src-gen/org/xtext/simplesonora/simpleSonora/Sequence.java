 ...
 *   <li>{@link org.xtext.simplesonora.simpleSonora.Sequence#getTuplet <em>Tuplet</em>}</li>
...
public interface Sequence extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Tuplet</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Tuplet</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Tuplet</em>' containment reference.
   * @see #setTuplet(Tuplet)
   * @see org.xtext.simplesonora.simpleSonora.SimpleSonoraPackage#getSequence_Tuplet()
   * @model containment="true"
   * @generated
   */
  Tuplet getTuplet();
  ...
  /**
   * Sets the value of the '{@link org.xtext.simplesonora.simpleSonora.Sequence#getTuplet <em>Tuplet</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Tuplet</em>' containment reference.
   * @see #getTuplet()
   * @generated
   */
  void setTuplet(Tuplet value);
